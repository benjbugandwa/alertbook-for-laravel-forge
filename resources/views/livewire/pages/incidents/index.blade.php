<div class="space-y-6 relative" x-data="{ createAlertLoading: false }" x-on:open-url.window="window.open($event.detail.url, '_blank')">
    {{-- Temporary suspension of the new-alert flow. Remove this overlay and the
         capture handler on the button below to restore the existing modal. --}}
    <div x-show="createAlertLoading" x-cloak
    ...
    <div class="flex items-start justify-between gap-4">
        ...
        <x-ui-button wire:click="openCreate"
            x-on:click.capture="createAlertLoading = true; $event.stopImmediatePropagation()">
            + Nouvelle alerte
        </x-ui-button>
